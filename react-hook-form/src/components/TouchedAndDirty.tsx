...
const TouchedAndDirty = () => {
  ...
  console.log(touchedFields); // when user interacted with the feild and onBlur triggered

  console.log(dirtyFields); // when user has modified the value. Will remain false if the value is same as default value. Only when default value changes the field becomes dirty

  console.log(isDirty); // becomes true if any of the form fields is modified (useful when we want to enable the form submit only when value is entered)
...
export default TouchedAndDirty;
