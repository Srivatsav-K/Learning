...
const FormSubmissionStates = () => {
  ...
  // isValid -> becomes true if all validations pass
  // isDirty -> becomes true if form values are different from default values
  const {
    errors,
    // isValid,
    //isDirty,
  ...
  console.log({ isSubmitting }); // Whether form is in the process of submitting (can disable submit during submission)
  console.log({ isSubmitted }); // Becomes true until form is submitted. Remains true unless form is reset
  console.log({ isSubmitSuccessful }); //  true when form is submitted successfully without runtime errors (validation errors)
  console.log({ submitCount }); // number of times form is submitted
...
export default FormSubmissionStates;
